...
en:{
  ...
  checkNote:"Your appointment notice lists exactly what to bring for your case. When in doubt, bring the original plus a copy.",
...
es:{
  ...
  checkNote:"Su notificación de cita indica exactamente qué llevar en su caso. Ante la duda, lleve el original más una copia.",
...
const CHECKLIST = [
  ...
  {sec:"docs", id:"passport", en:"All passports, current and expired", es:"Todos los pasaportes, vigentes y vencidos"},
  {sec:"docs", id:"photoid", en:"State photo ID (driver's license)", es:"Identificación con foto del estado (licencia de conducir)"},
  {sec:"docs", id:"n400copy", en:"Copy of your filed N-400 and everything you submitted", es:"Copia de su N-400 presentado y todo lo que envió"},
  {sec:"docs", id:"taxes", en:"Federal tax returns (last 3–5 years)", es:"Declaraciones de impuestos federales (últimos 3 a 5 años)"},
  {sec:"docs", id:"birth", en:"Birth certificate (+ certified English translation if not in English)", es:"Acta de nacimiento (+ traducción certificada al inglés si no está en inglés)"},
  ...
  {sec:"docs", id:"address", en:"Proof of address (utility bill, lease, bank statement)", es:"Prueba de domicilio (factura de servicios, contrato de alquiler, estado de cuenta)"},
  {sec:"docs", id:"court", en:"Court-certified arrest / court records", es:"Registros de arresto / judiciales certificados por el tribunal", cond:1},
  ...
  {sec:"day", id:"early", en:"Arrive 15–30 minutes early", es:"Llegue 15–30 minutos temprano"},
...
function practiceAnswer(ok){
  ...
  else { pz.wrong++; cr.w++; pz.missed.push(q); if(pz.review){ srsOnWrong(qkey(q.n)); } }
  pz.idx++;
